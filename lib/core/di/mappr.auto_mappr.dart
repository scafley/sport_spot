...
/// {@template package:sport_spot/core/di/mappr.dart}
/// Available mappings:
...
class $Mappr implements _i1.AutoMapprInterface {
  ...
  /// {@macro package:sport_spot/core/di/mappr.dart}
  @override
  bool canConvert<SOURCE, TARGET>({bool recursive = true}) {
    final sourceTypeOf = _typeOf<SOURCE>();
    final targetTypeOf = _typeOf<TARGET>();
    if ((sourceTypeOf == _typeOf<_i2.ActivityModel>() ||
            sourceTypeOf == _typeOf<_i2.ActivityModel?>()) &&
        (targetTypeOf == _typeOf<_i3.Activity>() ||
            targetTypeOf == _typeOf<_i3.Activity?>())) {
      return true;
    }
    if (recursive) {
  ...
  TARGET? _convert<SOURCE, TARGET>(
    ...
    if ((sourceTypeOf == _typeOf<_i2.ActivityModel>() ||
      ...
      return (_map__i2$ActivityModel_To__i3$Activity(
            (model as _i2.ActivityModel?),
          )
          as TARGET);
    }
  ...
  _i3.Activity _map__i2$ActivityModel_To__i3$Activity(
    _i2.ActivityModel? input,
  ) {
    final model = input;
    if (model == null) {
      throw Exception(
        r'Mapping ActivityModel → Activity failed because ActivityModel was null, and no default value was provided. '
        r'Consider setting the whenSourceIsNull parameter on the MapType<ActivityModel, Activity> to handle null values during mapping.',
      );
    }
    return _i3.Activity(
      id: model.id,
